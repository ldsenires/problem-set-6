...
![Jam - Heavy Traffic](top_alerts_map/jam_heavy_traffic.png){width=200}

c. 

![Road Closed - Event](top_alerts_map/road_closed_event.png){width=200}

d. 

Where are alerts for major accidents the most common?

![Accident - Major](top_alerts_map/accident_major.png){width=200}
...
# Combine plots and add Chicago base map
combined_plots = base_chicago + plots[0]

for plot in plots[1:]:
    combined_plots = combined_plots | (base_chicago + plot)
...
![UI - with slider](top_alerts_map_byhour/ui_select_slider.png){width=200}

b. 

![Jam - Heavy Traffic at 6am](top_alerts_map_byhour/jam_heavy_traffic_6am.png){width=200}

![Jam - Heavy Traffic at 12pm](top_alerts_map_byhour/jam_heavy_traffic_12pm.png){width=200}

![Jam - Heavy Traffic at 6pm](top_alerts_map_byhour/jam_heavy_traffic_6pm.png){width=200}

c. 

It seems that road construction is done more during night hours.

![No alerts for road construction at 7am](top_alerts_map_byhour/road_construction_7am.png){width=200}

![Multiple alerts for road construction at 7pm](top_alerts_map_byhour/road_construction_7pm.png){width=200}
